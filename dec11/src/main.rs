...
fn part1(input: &HashMap<u16, Vec<u16>>) -> u64 {
	fn find_path(map: &HashMap<u16, Vec<u16>>, at: u16) -> u64 {
		if at == OUT {
			return 1;
		}
		let nexts = &map[&at];
...
fn parse(input: &str) -> HashMap<u16, Vec<u16>> {
...
fn part2(input: &HashMap<u16, Vec<u16>>) -> u64 {
